// MyTexture.cpp: implementation of the CTexture class.
//
//////////////////////////////////////////////////////////////////////
...
void CTexture::ImageClose(ImageRec *image) 
{
    fclose(image->file);
    free(image->tmp);
    free(image->tmpR);
...
void CTexture::ImageGetRow(ImageRec *image, unsigned char *buf, int y, int z) 
{
...
unsigned * CTexture::read_texture(char *name, int *width, int *height, int *components) 
{
    unsigned *base, *lptr;
