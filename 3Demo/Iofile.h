...
public:
  ...
  IOFile& operator>>(int   &n ) { Read( &n, sizeof(int  ) ); return *this; }
  IOFile& operator>>(float &n ) { Read( &n, sizeof(float) ); return *this; }
  ...
  IOFile& operator<<(float &n ) { Write( &n, sizeof(float) ); return *this; }
